            ...
            <table class="table table-stritched table-hover">
                ...
                <tbody>
                    ...
                    <?php foreach($names as $name): ?>
                        ...
                        <td><?php echo $name['coursename']; ?></td>
                        <td><?php echo $name['student_count']; ?></td>
                        <td><a href="<?php echo base_url().'users/viewstudents/'?><?php echo $name['course_id']?>" class="btn btn-success">VIEW</a></td>
                    </tr>
                    <?php $count++; ?>
                        <?php endforeach; ?>
                </tbody>   
